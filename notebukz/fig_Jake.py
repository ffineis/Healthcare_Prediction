...
def plot_example_decision_tree():
    ...
    text(ax, 0.5, 0.9, "Do I have\nrunning water?", 20)
    text(ax, 0.3, 0.6, "How many cars\ndo I have?", 18)
    text(ax, 0.7, 0.6, "Do I have\na graduate degree?", 18)
    text(ax, 0.12, 0.3, "Am I in\nthe military?", 14)
    text(ax, 0.38, 0.3, "Am I a\nfemale?", 14)
    text(ax, 0.62, 0.3, "Do I receive\nfood stamps?", 14)
    text(ax, 0.88, 0.3, "Do I have more\nthan 1 child?", 14)

    text(ax, 0.4, 0.75, "yes", 12, alpha=0.4)
    text(ax, 0.6, 0.75, "no", 12, alpha=0.4)

    text(ax, 0.21, 0.45, "> 2", 12, alpha=0.4)
    text(ax, 0.34, 0.45, "< 2", 12, alpha=0.4)
